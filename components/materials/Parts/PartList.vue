...
const emit = defineEmits(["select", "close", "rowSelectedPart"]);
...
const handleSelectRow = () => {
  ...
  emit("rowSelectedPart", gridMeta.value.selectParts);

  emit("close");
  console.log(gridMeta.value.selectParts);
};
...
const onSelect = async (row) => {
  ...
  gridMeta.value.selectParts = row;
};
