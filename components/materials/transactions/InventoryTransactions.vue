...
<template>
        ...
        <div class="flex flex-col">
            ...
            <div class="py-2">
                ...
                <div class="flex flex-row space-x-3 p-4 pt-0">
                    ...
                    <div class="basis-1/2">
                        <UTable :rows="inventoryDetailGridMeta.details"
                            ...
                            <template v-for="column in inventoryDetailGridMeta.defaultColumns"
    ...
    <UDashboardModal v-model="isServiceReportModalOpen" title="Service Report" :ui="{
        ...
        <ServiceReportDetail :selected-complaint="null" :selected-service-report="selectedServiceReportID"
            @save="editInit" @close="" />
    </UDashboardModal>
